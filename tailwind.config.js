  ...
  theme: {
    extend: {
      colors: {
        ...
        // shadcn/ui token aliases. These intentionally map onto the
        // existing Dispatch theme variables so generated components do
        // not introduce a second visual system.
